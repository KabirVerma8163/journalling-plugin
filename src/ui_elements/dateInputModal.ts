 ...
 * 
 * ```typescript
 * // You'll need to import Luxon in your main file:
 * // import { DateTime } from "luxon";
 * 
 ...
 *   (selectedDate) => {
 *     console.log("Selected date:", selectedDate.toFormat("yyyy-MM-dd"));
 *     // Do something with the selected date
 *   },
 *   "yyyy-MM-dd" // Format to use
 * );
 * 
 * datePicker.open();
 * ```
 ...
 * 
 * ```typescript
 * const datePicker = new DatePickerModal(
 *   this.app,
 *   null, // Use current date
 *   (selectedDate) => {
...
//   constructor(app: App, onSubmit: (result: string) => any) {
//     super(app);
//     this.onSubmit = onSubmit;
//   }
...
//         this.onSubmit(selectedDate); // Call the onSubmit function
//       }
//     });
